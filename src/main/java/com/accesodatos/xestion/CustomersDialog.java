...
public class CustomersDialog extends javax.swing.JDialog {
    ...
    private void reloadList() {
        ...
        addElements(DB.getCustomers(con));
    ...
    private void removeSelectedElement() {
        ...
        if (selectedCustomer == null) {
            ...
            System.out.println("Vamos a borrar a " + selectedCustomer);
            int respuesta = JOptionPane.showConfirmDialog(null, "Quiere eliminar a \""
                    + dataSplit[0] + "\" de la lista de clientes?");
            if (respuesta == 0) {
//                String[] dataSplit = selectedCustomer.split("-> ");

//                System.out.println("Vamos a borrar a " + dataSplit[dataSplit.length-1]);
                String selectedEmail = dataSplit[1];

                con = DB.connectDatabase(db);
                DB.deleteCustormer(con, selectedEmail);
                DB.desconnetDatabase(con);
            }
        }
    }
