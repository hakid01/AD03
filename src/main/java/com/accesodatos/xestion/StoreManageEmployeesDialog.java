...
//        reloadList();
    ...
    public StoreManageEmployeesDialog(java.awt.Frame parent, boolean modal, String nameSelectedStore, int idSelectedStore) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(parent);
        listModel = new DefaultListModel();
    ...
    public void reloadList() {
        ...
        addElements(DB.getEmployeesStore(con, idSelectedStore));
    ...
    private void btnAddEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEmployeeActionPerformed
        ...
        lbError.setText("");
        StoreEmployeeCreateDialog secd = new StoreEmployeeCreateDialog(null, true, idSelectedStore);
